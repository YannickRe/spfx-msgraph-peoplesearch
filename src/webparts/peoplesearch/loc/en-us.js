define([], function () {
  return {
    ...
    InvalidNumberIntervalMessage:
      'Value needs to be at least 1 and maximum 999',
    ...
    PlaceHolderDescription:
      'This component displays people search results from Microsoft Graph',
    ...
    ShowBlankEditInfoMessage:
      'No result returned for this query. This Web Part will remain blank in display mode according to parameters.',
    ...
    TemplateParameters: {
      ...
      ManagePeopleFieldsPanelDescriptionLabel:
        'Here you can map each field values with the corresponding persona placeholders.',
